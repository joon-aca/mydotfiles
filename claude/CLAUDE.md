...
- Don't include co-authored by Claude in git comments
- Don't add Claude credits like:   🤖 Generated with [Claude Code](https://claude.ai/code)"
...
- Don't delete debugging until code has final confirmation it works
Final confirmation has to come from me.
...
- Favor verbose debugging out for complex tasks
- before creating new docs files work to update and consolidate existing docs to minimize md documentation file spam.
